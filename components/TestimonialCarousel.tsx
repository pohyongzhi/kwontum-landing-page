        ...
        <section className="py-12 bg-gray-100 dark:bg-gray-800">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <Swiper
                    ...
                    className=" flex justify-center items-center w-full p-10" // Adjust height
                >
                    {testimonials.map((testimonial) => (
                        ...
                        >
                            <div className="flex justify-center items-center">
                                <Card className="bg-white dark:bg-gray-900 border-2 border-[#72161D] rounded-xl p-6 flex flex-col justify-center items-center text-center">
